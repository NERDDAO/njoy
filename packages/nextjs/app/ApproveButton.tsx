...
const ApproveButton: React.FC<ApproveButtonProps> = ({ contractName, spenderAddress }) => {
  ...
  return (
    <div className="flex flex-col align-middle">
      <div className="relative h-[300px] w-1/3 p-12 bg-backdrop-blur-20 border-6 border-black">
        <Image src="/temp.jpg" className="" alt="Enjoy" fill />
      </div>
      <button
      ...
      <label className="relative left-1/2 -ml-32 top-12">
        Amount<input></input>
      </label>
    </div>
  );
