...
window.addEventListener("click", function(e) {
    if (dropupcontent.classList.contains("dropup-show") && !e.target.classList.contains("start-btn") && e.target.id != dropupcontent.id && e.target.parentElement.id != dropupcontent.id) toggleUp();
});
function toggleUp() {
